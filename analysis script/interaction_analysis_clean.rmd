...
Rhinovirus_TimeDependent$Rhinovirus_TimeDependent <- factor(Rhinovirus_TimeDependent$Rhinovirus_TimeDependent,
                                                           #,'30 < Day <= 60'
                                                            levels = c("No", 'Day <= 14','14 < Day <= 30', '30 < Day <= 60' ,"60 < Day <= 180", "180 < Day <= 365", "Day > 365"))
...
Rhinovirus_TimeDependent_cov %>%
  ggplot(aes(x = Rhinovirus_TimeDependent, y = Secondary_Group, group = Rhinovirus_TimeDependent)) +
  geom_point()
...
table(RSV_TimeDependent_cov$RSV_TimeDependent)
...
table(IAV_TimeDependent_cov$IAV_TimeDependent)
...
# Kaplan M curves showing non-proportional hazard
